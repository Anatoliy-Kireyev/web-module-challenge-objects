...
function createMenuItem(name, cost, category){
  myFavFood = {name, cost, category};
  return myFavFood;
}
//console.log(createMenuItem('steak', 15, 'Lunch'))
...
10% off for everyone else. Add a method to your burger object that automatically calculates price given a string as a parameter. 
...
/* Task 5: Add a new rating with your (fictitious) opinions of the restaurant in the same format as the reviews above. */
   ...
   //reviews.anatoliy = {name: "Anatoliy", rating: 5, feedback: "Food and service was great!"};
